  ...
  render() {
    return (
      <Menu
        ...
        <NavLink to="#!" onClick={() => this.closeMenu()} className="bm-item" tabIndex="2" activeClassName="active"><i className="far fa-calendar-alt"></i><span>Past Dailies</span></NavLink>
